...
chai.describe('App', () => {
  chai.describe('GET /', () => {
    chai.it(
      'should get a single artist and multiple related artists given an artist name',
      (done) => {
        const artist = 'clairo';
        chai
          .request(app)
    ...
    chai.it(
      'should not get a single artist nor related artists given a non existing artist name',
      (done) => {
    ...
    chai.it('should get related artists given an artist ID', (done) => {
    ...
    chai.it(
      'should not get any related artists given a non existing artist ID',
      (done) => {
